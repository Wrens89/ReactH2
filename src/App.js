  ...
  return (
    ...
    <main>
        ...
        <Product
            image={ijsblokjes}
            title="Ijsblokjes"
            description="Een ijsblokje of ijsklontje is bevroren water in de vorm van een klein blokje. Het wordt gemaakt in de diepvriezer door water in een plastic vorm te laten bevriezen."
            />
    </main>
          </>
  );
